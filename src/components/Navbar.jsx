  ...
  return (
    <nav ref={navRef} className="fixed top-0 left-0 w-full z-50 flex items-center px-8 md:px-16 py-6 transition-all duration-500">
      ...
      <div className="flex-1 flex items-center justify-end gap-8">
        ...
        <button className="liquid-electric text-surface px-6 py-2.5 rounded-sm text-[0.7rem] font-bold tracking-[0.2em] hover:opacity-90 transition-all cursor-pointer">
          LIST PROPERTY
        </button>
      </div>
